...
Cipher Interface. \TODO{Which cryptographic driver? You need to clarify if you
...
naive implementation can have disastrous effects on performance. \TODO{It is
...
When using forward switching other that 0-forward, \ie{N-forward} where $N
