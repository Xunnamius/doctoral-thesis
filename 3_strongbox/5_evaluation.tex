...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        {\input{data/sb/microbench-f2fs-sequential.tex}}
        \caption{Sequential I/O expanded F2FS result set.} \label{fig:microbench-f2fs-sequential}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\linewidth}
        \centering
        {\input{data/sb/microbench-f2fs-random.tex}}
...
%         \centering
%         {\input{data/sb/microbench-gamut-sequential-r.tex}}
%         \caption{Sequential reads.}
%        \label{fig:microbench-gamut-sequential-r}
%     \end{subfigure}\hspace*{0.5em}%
%     \begin{subfigure}{0.5\linewidth}
%         \centering
%         {\input{data/sb/microbench-gamut-sequential-w.tex}}
...
%         \vspace{0.5em}
%         \centering
%         {\input{data/sb/microbench-gamut-random-r.tex}}
%         \caption{Random reads.}
%        \label{fig:microbench-gamut-random-r}
%     \end{subfigure}%
%     \begin{subfigure}{0.5\linewidth}
%         \centering
%         {\input{data/sb/microbench-gamut-random-w.tex}}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        {\input{data/sb/microbench-ext4-sequential.tex}}
        \caption{Sequential I/O F2FS vs Ext4 result set.}
       \label{fig:microbench-ext4-sequential}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\linewidth}
        \centering
        {\input{data/sb/microbench-ext4-random.tex}}
...
\begin{figure}[t]
    ...
    \centering
    {\input{data/sb/microbench-aes-vs-chacha.tex}}
...
\begin{figure}[ht]
    ...
    \centering
    {\input{data/sb/microbench-f2fs-full.tex}}
