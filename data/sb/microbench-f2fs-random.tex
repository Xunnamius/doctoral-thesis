...
table[x=size, y=sR, col sep=space] {data/sb/microbench-f2fs-random.dat};
\addplot[fill=purpleDark, every node near coord/.append style={color=purpleDark}]
table[x=size, y=dR, col sep=space] {data/sb/microbench-f2fs-random.dat};
...
table[x=size, y=sW, col sep=space] {data/sb/microbench-f2fs-random.dat};
\addplot[draw=purpleDark, pattern=crosshatch, pattern color=purpleDark, every node near coord/.append style={color=purpleDark}]
table[x=size, y=dW, col sep=space] {data/sb/microbench-f2fs-random.dat};
