...
table[x=size, y=NILFS, col sep=space] {data/sb/microbench-gamut-random-w.dat};
\addplot[fill=purpleDark, every node near coord/.append style={color=purpleDark}]
table[x=size, y=F2FS, col sep=space] {data/sb/microbench-gamut-random-w.dat};
...
table[x=size, y=Ext4OJ, col sep=space] {data/sb/microbench-gamut-random-w.dat};
\addplot[draw=purpleLight, pattern=crosshatch, pattern color=purpleDark, every node near coord/.append style={color=purpleDark}]
table[x=size, y=Ext4FJ, col sep=space] {data/sb/microbench-gamut-random-w.dat};
